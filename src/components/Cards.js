...
const Cards = () => {
  return <section className='w-full bg-cardsBg min-h-[260px] pb-[55px] lg:-mt-24'>
    ...
    <div className="container mx-auto flex flex-col lg:flex-row gap-x-[32px]">
      ...
      <div className='flex flex-1 gap-x-[15px] lg:gap-x-[32px] -mt-[38px] z-10 lg:-mt-[77px] mx-auto'>
        {/* Card One */}
        <div className='bg-white w-full max-w-[282px] max-h-[282px] rounded-md p-[14px] lg:p-[26px] shadow-2xl'>
          {/* Card text */}
      ...
      {/* Card 3*/}
      <div className='items-start shadow-2xl w-full rounded-md flex justify-between max-w-[542px] mx-auto p-[26px] lg:-mt-[77px] bg-pink-200 z-10 mt-4'>
