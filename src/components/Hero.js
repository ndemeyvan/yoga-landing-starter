  ...
  return <section className='min-h-[518px] lg:min-h-[815px] pt-9 lg:bg-circle lg:bg-no-repeat lg:bg-right-top '>
    <div className="container mx-auto   mt-[160px]">
      ...
      <div className='flex flex-col items-center lg:flex-row lg:items-start pt-23'>
        <div className=''>
          <h1 className='h1 mb-3  lg:mb-[22px]' data-aos='fade-down' data-aos-delay='300'>Yoga to <br /> Release stress </h1>
          <p data-aos='fade-down' data-aos-delay='400'
            className='mb-6 lg:mb-12 max-w-[480px] lg:text-lg'>Yoga is way to life , rather than chore , counteract the stresses of modern life by becoming more mindful and compasionate.</p>
          {/* Btn group */}
          <div className='mb-12 space-x-4' data-aos='fade-down' data-aos-delay='500'
>
        ...
        <div className='w-full bg-circle bg-cover lg:bg-none lg:w-auto'>
          <div className='flex-1 flex justify-center lg:justify-end' data-aos='fade-left' data-aos-delay='500'
>
